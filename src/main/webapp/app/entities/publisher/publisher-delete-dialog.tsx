...
export const PublisherDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="libraryManagementApp.publisher.delete.question">Are you sure you want to delete this Publisher?</ModalBody>
      <ModalFooter>
